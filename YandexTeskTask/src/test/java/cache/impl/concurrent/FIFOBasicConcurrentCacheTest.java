 ...
 */
public class FIFOBasicConcurrentCacheTest {
    private static final int NUMBER_OF_WRITERS = 4;
    private static final int NUMBER_OF_READERS = 3;
    private static final Cache<Integer, String> cache = new DefaultCache<>(TYPE.FIFO, 30_000);
    ...
    public void setUp() throws InterruptedException, ExecutionException {
        ...
        // This action won't affect FIFO cache
        ...
        final Future<Set<String>> firstFuture = executor.submit(new Reader(20_000, 30_000));
